...
export function RegisterForm() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <div>
          <label htmlFor="register-email" className="mb-1.5 block text-sm font-medium text-text-2">
            E-mail
          </label>
          <input
            id="register-email"
        ...
        <div>
          <label htmlFor="register-password" className="mb-1.5 block text-sm font-medium text-text-2">
            Senha
          </label>
          <input
            ...
            className="w-full rounded-xl border border-border bg-bg px-4 py-3 text-text-1 outline-none ring-accent-light/40 transition focus:ring-2"
          />
          <p className="mt-1 text-xs text-text-3">Mínimo de 8 caracteres.</p>
