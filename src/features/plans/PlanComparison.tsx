...
const PLAN_CONFIGS: PlanConfig[] = [
  {
    ...
    features: [
      ...
      { text: "Alertas de live para até 3 perfis monitorados", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Alertas de live para até 15 perfis monitorados", included: true, highlight: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Alertas de live para perfis monitorados ilimitados", included: true, highlight: true },
    ],
  },
];
